...
HD_PWD='/home/gwrw/fir1/fir1.runs/ila_qd_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ila_qd.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ila_qd.tcl
