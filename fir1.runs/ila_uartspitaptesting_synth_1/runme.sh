...
HD_PWD='/home/gwrw/fir1/fir1.runs/ila_uartspitaptesting_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ila_uartspitaptesting.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ila_uartspitaptesting.tcl
