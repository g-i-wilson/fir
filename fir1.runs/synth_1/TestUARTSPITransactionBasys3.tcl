...
namespace eval ::optrace {
  variable script "/home/gwrw/fir1/fir1.runs/synth_1/TestUARTSPITransactionBasys3.tcl"
...
read_vhdl -library xil_defaultlib {
  ...
  /home/gwrw/fir1/fir1.srcs/sources_1/new/TestSPITransactionBasys3.vhd
}
...
synth_design -top TestUARTSPITransactionBasys3 -part xc7a35tcpg236-1
...
write_checkpoint -force -noxdef TestUARTSPITransactionBasys3.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
create_report "synth_1_synth_report_utilization_0" "report_utilization -file TestUARTSPITransactionBasys3_utilization_synth.rpt -pb TestUARTSPITransactionBasys3_utilization_synth.pb"
