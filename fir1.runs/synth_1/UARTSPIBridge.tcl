...
namespace eval ::optrace {
  variable script "/home/gwrw/fir1/fir1.runs/synth_1/UARTSPIBridge.tcl"
...
read_vhdl -library xil_defaultlib {
  ...
  /home/gwrw/fir1/fir1.srcs/sources_1/new/SeralTx-disabled.vhd
...
synth_design -top UARTSPIBridge -part xc7a35tcpg236-1
...
write_checkpoint -force -noxdef UARTSPIBridge.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
create_report "synth_1_synth_report_utilization_0" "report_utilization -file UARTSPIBridge_utilization_synth.rpt -pb UARTSPIBridge_utilization_synth.pb"
