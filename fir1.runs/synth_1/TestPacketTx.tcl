...
namespace eval ::optrace {
  variable script "/home/gwrw/fir1/fir1.runs/synth_1/TestPacketTx.tcl"
...
read_vhdl -library xil_defaultlib {
  ...
  /home/gwrw/fir1/fir1.srcs/sources_1/new/TestPacketTx.vhd
}
...
synth_design -top TestPacketTx -part xc7a35tcpg236-1
...
write_checkpoint -force -noxdef TestPacketTx.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
create_report "synth_1_synth_report_utilization_0" "report_utilization -file TestPacketTx_utilization_synth.rpt -pb TestPacketTx_utilization_synth.pb"
