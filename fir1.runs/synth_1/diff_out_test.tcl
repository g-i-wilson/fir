...
namespace eval ::optrace {
  variable script "/home/gwrw/fir1/fir1.runs/synth_1/diff_out_test.tcl"
...
set_param synth.incrementalSynthesisCache ./.Xil/Vivado-28119-black-computer/incrSyn
...
synth_design -top diff_out_test -part xc7a35tcpg236-1
...
write_checkpoint -force -noxdef diff_out_test.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
create_report "synth_1_synth_report_utilization_0" "report_utilization -file diff_out_test_utilization_synth.rpt -pb diff_out_test_utilization_synth.pb"
