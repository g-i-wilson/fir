...
HD_PWD='/home/gwrw/fir1/fir1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TestUARTSPITransactionBasys3.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TestUARTSPITransactionBasys3.tcl -notrace
